<template>
  <div>
    <div class="box" v-show="isshow && !isSmall">
      <div class="header">
        <div class="text">投标宝盒河北专区</div>
        <div class="btn">
          <img src="~@/assets/img/public/chat_small.png" alt="" @click="small" />
          <img src="~@/assets/img/public/chat_close.png" alt="" @click="close" />
        </div>
      </div>
      <div class="content">
        <div class="con">
        ...
        <div class="message">
          <div class="message_c">
            <textarea name="" id="message" v-model="form.content" placeholder="请输入..." @keyup.enter="send"></textarea>
          </div>
        </div>
    ...
    <div class="small" v-show="isshow && isSmall">
      <div class="header_small">
        <div class="text">
          <span>投标宝盒河北专区</span>
        </div>
        <div class="btn">
          <img src="~@/assets/img/public/chat_big.png" alt="" @click="big" />
          <img src="~@/assets/img/public/chat_close.png" alt="" @click="close_small" />
        </div>
      </div>
    </div>
  </div>
